...
if __name__ == "__main__":
    ...
    vensimModel.outcomes = [TimeSeriesOutcome('Food provision by MF'),
                            ...
                            TimeSeriesOutcome('Relative profitability MF vs regular fish'),
                            TimeSeriesOutcome('Harvested fish in Gt'),
                            TimeSeriesOutcome('Effort'),
                            TimeSeriesOutcome('net uptake ocean'),
                            TimeSeriesOutcome('Mesopelagic fish juvinile'),
                            TimeSeriesOutcome('Mesopelagic fish adult'),
                            TimeSeriesOutcome('Quota')
                            ]

    ema_logging.log_to_stderr(ema_logging.INFO)

    n_scenarios = 1000 # 10.000
    ...
    save_results(results, './Data/results_step5.tar.gz')
