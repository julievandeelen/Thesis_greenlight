...
if __name__ == "__main__":
    ...
    policies = [Policy('no policy',
                       model_file='model_thesis_np.vpmx'),
                Policy('Static policy high',
                       model_file='model_thesis_static_high.vpmx'),
                Policy('Static policy low',
                       model_file='model_thesis_static_low.vpmx'),
                Policy('Static policy zero',
                       model_file='model_thesis_static_zero.vpmx')
                ]
    ...
    save_results(results, './Data/results_o_e7_zeropol100.tar.gz')
