...
if __name__ == "__main__":
    ...
    with MultiprocessingEvaluator(vensimModel) as evaluator:
        results, convergence = evaluator.optimize(nfe=800000, searchover='levers', convergence=convergence_metrics,
                                      epsilons=[0.05,] * len(vensimModel.outcomes) , Scenario=ref_scen)


    results.to_excel('./Data/results_convergence7_supercomp4.xlsx')
    convergence.to_excel('./Data/conv_convergence7_supercomp4.xlsx')
